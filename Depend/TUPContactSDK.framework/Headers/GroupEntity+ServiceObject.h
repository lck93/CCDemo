...
typedef NS_ENUM(NSInteger, ECSMarkGroupType){
    ECSMarkGroupTypeMute = 1,       /**< [en]Indicates mute .
                                     <br>[cn]静音 */
    ECSMarkGroupTypeFix = 2,        /**< [en]Indicates persistence .
                                     <br>[cn]固化 */
    ECSMarkGroupTypeFavourite = 3,  /**< [en]Indicates like.
                                     <br>[cn]喜欢 */
};
...
@property (nonatomic, strong) NSString *ownedByUserName;//string 拥有者的名称
