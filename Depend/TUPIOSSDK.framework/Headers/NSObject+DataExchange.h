...
@protocol ESpaceJSONSecurityProtocol <NSObject>

- (NSString *)encryptStringForProperty:(NSString *)propertyName;
@end

typedef NS_ENUM(NSInteger, ECSDataExchangeType) {
    ECSDataExchangeTypeJSON,
    ECSDataExchangeTypeXML,
    ECSDataExchangeTypeSOAP
};

@interface NSObject (DataExchange)
...
/**
 ...
 @param data The JSON string to deserialize into the returned object.
...
/**
 ...
 @return The newly-initialized object.
 */
- (instancetype)initWithObjectData:(NSData *)data type:(ECSDataExchangeType)type;
...
@interface ECSSOAPObject : NSObject
