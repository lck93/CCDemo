...
typedef NS_ENUM(NSInteger, ESpaceUserStatus) {
    ESpaceUserStatusUnknown = -1,           /**< [en]Indicates unknown.
                                             <br>[cn] 未知*/
    ESpaceUserStatusAvailable = 1,          /**< [en]Indicates available.
                                             <br>[cn] 在线 */
    ESpaceUserStatusBusy = 2,               /**< [en]Indicates status busy.
                                             <br>[cn] 繁忙 */
    ESpaceUserStatusAway = 3,               /**< [en]Indicates status away.
                                             <br>[cn] 离开 */
    ESpaceUserStatusOffline = 4,            /**< [en]Indicates offlilne.
                                             <br>[cn] 离线 */
    ESpaceUserStatusUninteruptable = 5      /**< [en]Indicates uninteruptable.
                                             <br>[cn] 免打扰 */
};
