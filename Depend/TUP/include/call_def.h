...
typedef enum tagCALL_E_CALL_EVENT
{
    ...
    CALL_E_EVT_DEVICE_HOWL_STATUS,                  /**< [en]Indicates the howl info notify
                                                                    ...
                                                                    <br>param3：TUP_UINT32 status [en] Indicates howling status 0:no howling 1: process howling 2:Signal Sound howling.[cn]啸叫状态 0: 表示无howling 1: 表示过程检测出howling 2: 表示信号音检测出howling
                                                                    <br>data：null */                                                                    
    CALL_E_EVT_BUTT
} CALL_E_CALL_EVENT;
...
#define  CALL_D_CFG_MEDIA_SEND_EC_PKT_IN_RTP      CFG_ID_DEF(CALL_E_CFG_MEDIA, CALL_E_CFG_DATA_TYPE_BOOL,          0x18, 0)   /**< [en]Indicates global configuration: Send EC packet in RTP stream, default FALSE
