...
#define IM_D_ICON_LENGTH                (1024)     /**< [en]Indicates the icon length
                                                         <br>[cn]图标长度 */
#define IM_D_MAX_ACCOUNT_LENGTH         (32)       /**< [en]Indicates the account length
                                                         <br>[cn]帐号长度 */
...
typedef enum tagIM_E_CLIENT_TYPE 
{
    ...
    IM_E_CLIENT_TYPE_WEB                                    = 2,    /**< [en]Indicates web
                                                                         <br>[cn]web客户端 */
    IM_E_CLIENT_TYPE_MOBLIEHD                               = 3     /**< [en]Indicates mobile PC
                                                                         <br>[cn]移动PC终端 */
}IM_E_CLIENT_TYPE;
...
typedef struct tagIM_S_IMGROUPINFO
{
    ...
    TUP_CHAR    manifesto[IM_D_MAX_DESC_LENGTH];                    /**< [en]Indicates bulletin. [cn] 公告 */
    TUP_CHAR    desc[IM_D_MAX_DESC_LENGTH];                         /**< [en]Indicates description. [cn] 简介 */
...
typedef struct tagIM_S_LOGIN_ARG
 {
    ...
    IM_E_LOGIN_AUTHTYPE    authType;                                /**< [en]Indicates type of authentication used for login(optional) reference tagIM_E_LOGIN_AUTHTYPE. [cn]登陆使用的鉴权类型，取值：参考tagIM_E_LOGIN_AUTHTYPE (选填，默认为账号登陆)[TODO] */
...
typedef struct tagIM_S_PANELINFO
{
    ...
    IM_E_SYNC_TYPE    state;                                        /**< [en]Indicates workspace panel status reference tagIM_E_SYNC_TYPE. [cn]工作台面状态，取值：参考：tagIM_E_SYNC_TYPE[TODO] */
}IM_S_PANELINFO;
...
typedef struct tagIM_S_COMPONETINFO
{
    ...
    TUP_CHAR    type[IM_D_GENEAL_LENGTH];                           /**< [en]Indicates plug-in type. [cn]插件类型[TODO] */
    ...
    TUP_CHAR    protocol[IM_D_GENEAL_LENGTH];                       /**< [en]Indicates protocol type. [cn]协议类型[TODO] */
    IM_E_SYNC_TYPE    state;                                        /**< [en]Indicates plug-in status reference tagIM_E_SYNC_TYPE. [cn]插件状态，取值：参考：tagIM_E_SYNC_TYPE[TODO] */
}IM_S_COMPONETINFO;
...
typedef struct tagIM_S_SENDIM_ARG
{
    ...
    IM_E_IM_CHAT_TYPE    chatType;                                  /**< [en]Indicates IM type (required) reference tagIM_E_IM_CHAT_TYPE. [cn]IM消息类型(必填)，取值：参考tagIM_E_IM_CHAT_TYPE[TODO] */
    IM_E_IM_CHAT_SOURCE_FLAG    sourceFlag;                         /**< [en]Indicates IM source (from where the IM is sent) (required). [cn]IM消息发自哪里(必填) */
    IM_E_IM_CHAT_CONTENT_TYPE    contentType;                       /**< [en]Indicates IM content format (required) reference tagIM_E_IM_CHAT_CONTENT_TYPE. [cn]IM消息内容格式(必填)，取值：参考tagIM_E_IM_CHAT_CONTENT_TYPE[TODO] */
    ...
    IM_E_IM_CHATMEDIA_TYPE mediaType;                               /**< [en]Indicates media type reference tagIM_E_IM_CHATMEDIA_TYPE. [cn]媒体类型，取值：参考tagIM_E_IM_CHATMEDIA_TYPE[TODO] */
}IM_S_SENDIM_ARG;
...
{
    IM_E_IM_HISTORYMESSAGEOP_TYPE    opType;                        /**< [en]Indicates operation type reference tagIM_E_IM_HISTORYMESSAGEOP_TYPE. [cn]操作类型，取值：参考tagIM_E_IM_HISTORYMESSAGEOP_TYPE[TODO] */
    IM_E_IM_HISTORYMESSAGEMSG_TYPE    msgType;                      /**< [en]Indicates the type of request message reference tagIM_E_IM_HISTORYMESSAGEMSG_TYPE. [cn]请求的消息类型，取值：参考tagIM_E_IM_HISTORYMESSAGEMSG_TYPE[TODO] */
...
typedef struct tagIM_S_QUERYHISTORYMESSAGE_ACK
{
    ...
    IM_E_IM_HISTORYMESSAGEOP_TYPE    opType;                        /**< [en]Indicates operation type reference tagIM_E_IM_HISTORYMESSAGEOP_TYPE. [cn]操作类型，取值：参考tagIM_E_IM_HISTORYMESSAGEOP_TYPE[TODO] */
    IM_E_IM_HISTORYMESSAGEMSG_TYPE    msgType;                      /**< [en]Indicates message type reference tagIM_E_IM_HISTORYMESSAGEMSG_TYPE. [cn]请求的消息类型，取值：参考tagIM_E_IM_HISTORYMESSAGEMSG_TYPE[TODO] */
...
{
    IM_E_IM_CHAT_TYPE    chatType;                                  /**< [en]Indicates IM type reference tagIM_E_IM_CHAT_TYPE. [cn]IM消息类型，取值：参考tagIM_E_IM_CHAT_TYPE[TODO] */
    TUP_INT     sourceFlag;                                         /**< [en]Indicates IM source (from where the IM is sent). [cn]IM消息发自哪里 */
    TUP_INT     contentType;                                        /**< [en]Indicates IM content format. [cn]IM消息内容格式[TODO] */
...
typedef struct tagIM_S_SMSINFO
{
    ...
    IM_E_SMS_NOTIFY_TYPE    smsType;                                /**< [en]Indicates type of received messages reference tagIM_E_SMS_NOTIFY_TYPE. [cn]接收到的短信消息的类型,取值：参考tagIM_E_SMS_NOTIFY_TYPE[TODO] */
}IM_S_SMSINFO;
...
{
    IM_E_IM_HISTORYMESSAGEMSG_TYPE msgType;                         /**< [en]Indicates message type reference tagIM_E_IM_HISTORYMESSAGEMSG_TYPE. [cn]消息类型，取值：参考tagIM_E_IM_HISTORYMESSAGEMSG_TYPE[TODO] */
...
typedef struct tagIM_S_QUERY_USERINFO_ARG
{
    ...
    IM_E_IMUSERQUERYTYPE    type;                                   /**< [en]Indicates keyword type reference tagIM_E_IMUSERQUERYTYPE. [cn]关键词类型，取值：参考tagIM_E_IMUSERQUERYTYPE[TODO] */
...
typedef struct tagIM_S_UNDELIVER_NOTIFY
{
    ...
    IM_E_UNDELIVER_MSG_TYPE type;                                   /**< [en]Indicates the non-delivery message type reference tagIM_E_UNDELIVER_MSG_TYPE. [cn]未送达消息类型，取值：参考tagIM_E_UNDELIVER_MSG_TYPE[TODO] */
...
typedef struct tagIM_S_GENERAL_NOTIFY
{
    ...
    IM_E_IM_GENERAL_NOTIFY_TYPE    flag;                            /**< [en]Indicates message notification type reference tagIM_E_IM_GENERAL_NOTIFY_TYPE. [cn]消息通知类型，取值：参考tagIM_E_IM_GENERAL_NOTIFY_TYPE[TODO] */ 
}IM_S_GENERAL_NOTIFY;
...
typedef struct tagIM_S_LEAVE_DISCUSSGROUP_ACK
{
    ...
    IM_E_IMGROUP_TYPE    grouptype;                                 /**< [en]Indicates group type reference tagIM_E_IMGROUP_TYPE. [cn]群组类型，取值：参考tagIM_E_IMGROUP_TYPE[TODO] */
...
typedef struct tagIM_S_USERSTATUS_NOTIFY
 {
    ...
    IM_E_CLIENT_TYPE    clientType;                                 /**< [en]Indicates client type reference tagIM_E_CLIENT_TYPE. [cn]客户端类型，取值：参考tagIM_E_CLIENT_TYPE[TODO] */
...
typedef struct tagIM_S_SENDIMINPUT_NOTIFY
{
    ...
    IM_E_IM_CHAT_STATUS    status;                                  /**< [en]Indicates IM typing status reference tagIM_E_IM_CHAT_STATUS. [cn]IM聊天输入状态，取值：参考tagIM_E_IM_CHAT_STATUS[TODO] */
...
{
    IM_E_USER_ONLINESTATUS    status;                                /**< [en]Indicates new status reference tagIM_E_USER_ONLINESTATUS. [cn]新状态，取值：参考tagIM_E_USER_ONLINESTATUS[TODO] */
...
typedef struct tagIM_S_MULTIDEVICE_NOTIFY
{
    ...
    IM_E_CLIENT_TYPE    clientType;                                  /**< [en]Indicates client type reference tagIM_E_CLIENT_TYPE. [cn]客户端类型，取值：参考tagIM_E_CLIENT_TYPE[TODO] */
    IM_E_CLIENT_OPT_TYPE    eventType;                               /**< [en]Indicates client operation event type reference tagIM_E_CLIENT_OPT_TYPE. [cn]客户端操作事件类型，取值：参考tagIM_E_CLIENT_OPT_TYPE[TODO] */
...
typedef struct tagIM_S_MEETINGINFO
{
    ...
    TUP_INT     status;                                             /**< [en]Indicates conference status. [cn]会议状态[TODO] */
    ...
    TUP_CHAR    mediaType[IM_D_MAX_STATUS_DESCLEN];                 /**< [en]Indicates media type. [cn]媒体类型[TODO] */
}IM_S_MEETINGINFO;
...
{
    IM_E_IM_RECENT_CONVERSATION_TYPE  type;                         /**< [en]Indicates conversation type reference tagIM_E_IM_RECENT_CONVERSATION_TYPE. [cn]会话类型,取值：参考tagIM_E_IM_RECENT_CONVERSATION_TYPE[TODO] */
...
typedef struct tagIM_S_DEL_RECENT_CONVERSATION_ARG
{
    ...
    IM_E_IM_RECENT_CONVERSATION_TYPE  type;                         /**< [en]Indicates recnet conversation type reference tagIM_E_IM_RECENT_CONVERSATION_TYPE. [cn]最近会话类型，取值：参考tagIM_E_IM_RECENT_CONVERSATION_TYPE[TODO] */
...
{
    IM_E_DISGROUP_OP_TYPE    type;                                  /**< [en]Indicates operation type reference tagIM_E_DISGROUP_OP_TYPE. [cn]讨论组操作类型，取值：参考tagIM_E_DISGROUP_OP_TYPE[TODO] */ 
