 ...
 * 
 * @attention [en]This interface must be invoked after the log is started
 *            <br>[cn] 必须在组件日志开启之后调用
 * @see tup_call_log_update_level
 **/
TUP_API TUP_VOID tup_call_log_update_level(TUP_INT32 logLevel);			
...
/*打开或者关闭通道声音/视频/辅流数据*/
TUP_API TUP_RESULT tup_call_switch_channel(TUP_UINT32 ulCallID, TUP_BOOL bStop, CALL_E_MEDIATYPE eMediaType);
